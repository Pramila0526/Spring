...
public class ServiceImp implements com.bridgelabz.services.Service {
	...
	public String loginUser(@Valid Logindto loginDTO) {
		...
		if (user.getEmail().equals(loginDTO.getEmail())	&& confing.encoder().matches(loginDTO.getPassword(), user.getPassword())  ) {   //encode the user password
	...
	public String deleteUser(String id) {
		User user_id = repo.findById(id).get();
		 if(user_id==null) { throw new Deleteexception(MessageReference.USER_ID_NOT_FOUND); }
